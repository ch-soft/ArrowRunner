Shader "DevCarlin/BlinnPhongFresnel"
{
    Properties
    {
    ...
    SubShader
    {
		...
		#pragma surface surf MobileBlinnPhong exclude_path:prepass nolightmap noforwardadd halfasview interpolateview keepalpha vertex:vert
		...
		void vert( inout appdata_full v, out Input o ) 
		{
		   ...
		   o.worldViewDir0 = normalize( UnityWorldSpaceViewDir( worldPos ) );
		}
        ...
        void surf (Input IN, inout SurfaceOutput o)
        {
			...
			//c.rgb = dot( IN.worldNormal, IN.worldViewDir );
			//c.rgb = IN.worldViewDir0;

			float fresnel = dot( IN.worldNormal, IN.worldViewDir0 );
